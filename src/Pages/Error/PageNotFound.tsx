import ErrolStyles from 'Playground/SCSS/ErrorPageNotFound.module.scss'
function PageNotFound () {
    return (
        ...
        <div>
            ...
            <div className={ErrolStyles["message-box"]}>
                <h1>404</h1>
                <p>Page not found</p>
                <div className={ErrolStyles["buttons-con"]}>
                    <div className={ErrolStyles["action-link-wrap"]}>
                        <a href="/login" className={`${ErrolStyles["link-button"]} ${ErrolStyles["link-back-button"]}`}>Login</a>
                        <a href='/' className={`${ErrolStyles["link-button"]} ${ErrolStyles["link-back-button"]}`} >Go to Home Page</a>
                    </div>
                </div>
            </div>
        </div>
